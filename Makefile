...
all:	upstart_as_service	upstart	sensing	sensing_ranlib	sensing_ar	mq7_o	mq135_o	alerts_o	lm35_o	display_o	ldr_o	adc_o
...
sensing_ar:	mq7_o	mq135_o	alerts_o	lm35_o	display_o	ldr_o	adc_o
	ar crv ./bin/libsensing.a ./bin/adc.o ./bin/ldr.o ./bin/display.o ./bin/lm35.o ./bin/alerts.o ./bin/mq135.o ./bin/mq7.o
